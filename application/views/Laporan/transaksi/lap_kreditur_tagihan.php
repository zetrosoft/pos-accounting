...
link_js('auto_sugest.js,lap_kreditur_tagihan.js,jquery.fixedheader.js','asset/js,'.$path.'/js,asset/js');
panel_begin('Tagihan Kredit');
panel_multi('tagihankredit','block',false);
if($all_tagihankredit!=''){
