...
$(document).ready(function(e) {
	...
	$('#frm1 #optional').val(" and left(dt.nm_barang,5)<>'RESEP' order by dt.tgl_transaksi");
	$('#frm1 #dari_tgl')
		.click(function(){
			$(this).focus().select();
		})
	...
	$('#frm1 #nm_dokter')
		.keyup(function(){
			var path=$('#path').val();
			pos_div('#frm1 input#nm_dokter');
			auto_suggest(path+'penjualan/get_dokter',$(this).val(),$(this).attr('id')+'-frm1');
		})
		.keypress(function(e){
			if(e.which==13){
				//$('.autosuggest').hide();
