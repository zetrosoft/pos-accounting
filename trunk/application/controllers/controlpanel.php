...
class Controlpanel extends CI_Controller {
	...
	function get_data_menu(){
		...
		if($mnu[1]!="x"){
			...
			echo ($jml_sub==0)? 
			   "<td class='kotak'><input type='checkbox' id='c-".str_replace('/','__',$mnu[1])."' value='c-".$mnu[1]."' onclick=\"mnu_onClick('c','".str_replace('/','__',$mnu[1])."');\"".$this->control_model->cek_oto_x('c',$mnu[1],$nmgrp)." ".$this->zetro_auth->lock('c','authorization')." ".$this->un_required($mnu[3],'c')."></td>\n
				<td class='kotak'><input type='checkbox' id='e-".str_replace('/','__',$mnu[1])."' value='e-".$mnu[1]."' onclick=\"mnu_onClick('e','".str_replace('/','__',$mnu[1])."');\"".$this->control_model->cek_oto_x('e',$mnu[1],$nmgrp)." ".$this->zetro_auth->lock('c','authorization')." ".$this->un_required($mnu[3],'e')."></td>\n
				<td class='kotak'><input type='checkbox' id='v-".str_replace('/','__',$mnu[1])."' value='v-".$mnu[1]."' onclick=\"mnu_onClick('v','".str_replace('/','__',$mnu[1])."');\"".$this->control_model->cek_oto_x('v',$mnu[1],$nmgrp)." ".$this->zetro_auth->lock('c','authorization')." ".$this->un_required($mnu[3],'v')."></td>\n
				<td class='kotak'><input type='checkbox' id='p-".str_replace('/','__',$mnu[1])."' value='p-".$mnu[1]."' onclick=\"mnu_onClick('p','".str_replace('/','__',$mnu[1])."');\"".$this->control_model->cek_oto_x('p',$mnu[1],$nmgrp)." ".$this->zetro_auth->lock('c','authorization')." ".$this->un_required($mnu[3],'p')."></td>\n":
			...
			if($jml_sub>0){
				for ($z=1;$z<=$jml_sub;$z++){
					...
					echo "<tr id='".$mnu[0]."' class='".$sub_mnu[0]." xx' align='center'>
						  ...
						  <td class='kotak'><input type='checkbox' id='c-".str_replace('/','__',$sub_mnu[1])."' value='c-".$mnu[1]."' onclick=\"mnu_onClick('c','".str_replace('/','__',$sub_mnu[1])."');\"".$this->control_model->cek_oto_x('c',$sub_mnu[1],$nmgrp)." ".$this->zetro_auth->lock('c','authorization')." ".$this->un_required($sub_mnu[3],'c')."></td>\n
						  <td class='kotak'><input type='checkbox' id='e-".str_replace('/','__',$sub_mnu[1])."' value='e-".$mnu[1]."' onclick=\"mnu_onClick('e','".str_replace('/','__',$sub_mnu[1])."');\"".$this->control_model->cek_oto_x('e',$sub_mnu[1],$nmgrp)." ".$this->zetro_auth->lock('c','authorization')." ".$this->un_required($sub_mnu[3],'e')."></td>\n
						  <td class='kotak'><input type='checkbox' id='v-".str_replace('/','__',$sub_mnu[1])."' value='v-".$mnu[1]."' onclick=\"mnu_onClick('v','".str_replace('/','__',$sub_mnu[1])."');\"".$this->control_model->cek_oto_x('v',$sub_mnu[1],$nmgrp)." ".$this->zetro_auth->lock('c','authorization')." ".$this->un_required($sub_mnu[3],'v')."></td>\n
						  <td class='kotak'><input type='checkbox' id='p-".str_replace('/','__',$sub_mnu[1])."' value='p-".$mnu[1]."' onclick=\"mnu_onClick('p','".str_replace('/','__',$sub_mnu[1])."');\"".$this->control_model->cek_oto_x('p',$sub_mnu[1],$nmgrp)." ".$this->zetro_auth->lock('c','authorization')." ".$this->un_required($sub_mnu[3],'p')."></td>\n
						  </tr>\n";
					}
			}
		}
