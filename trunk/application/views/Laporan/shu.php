...
link_js('shu.js',$path.'/js');
panel_begin('SHU');
panel_multi('sisahasilusaha','block');
if($all_sisahasilusaha!=''){
...
<table id='period' style='border-collapse:collapse'>
	<tr><td width='90px'>Periode :</td>
    	<td width='20px'>&nbsp;</td>
        <td width='120px'>Periode Tanggal</td>
        <td width='150px'><input type='text' id='tgl_start' name='tgl_start' class='w100' value='' /></td>
        <td width='10px' align='center'>s/d</td>
        <td width='150px'><input type='text' id='tgl_stop' name='tgl_stop' class='w100' value='' /></td>
	...
	<tr><td>&nbsp;</td>
        ...
        <td width='10px' align='center'>s/d</td>
        <td width='150px'><input type='text' id='tgl_bstop' name='tgl_bstop' class='w100' value='' /></td>
        <td style='border-right:2px dotted #FFF' width='15px'></td>
        <td colspan='7'>&nbsp;</td>
        <td colspan='3'>&nbsp;</td>
    </tr>
