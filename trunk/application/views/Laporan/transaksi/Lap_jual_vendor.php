...
panel_begin('Penjualan by Anggota');
panel_multi('penjualanbyanggota','block',false);
if($all_penjualanbyanggota!=''){
...
$(document).ready(function(e) {
    $('#penjualanbyanggota').removeClass('tab_button');
	$('#penjualanbyanggota').addClass('tab_select');
});
</script>