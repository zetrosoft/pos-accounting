...
<table id='period' style='border-collapse:collapse'>
	<tr><td width='70px'>Periode :</td>
    	<td width='20px'><input type='radio' name='periode' id='pertahun' /></td>
        <td width='70px'>Per Tahun</td>
        <td width='100px'><select id='tahun'></select></td>
        <td width='20px'>&nbsp;</td>
        <td width='100px'><input type='button' id='oke' value='OK'></td>
